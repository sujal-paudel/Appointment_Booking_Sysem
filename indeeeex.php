...
// {
//     global $con;
//     $query = "SELECT * FROM prestb WHERE AppID = '$id'";
...
if (isset($_GET['cancel'])) {
    $AppID = $_GET['AppID'];
    $query = mysqli_query($con, "UPDATE appointmenttb SET userStatus = 0 WHERE AppID = '$AppID'");
    if ($query) {
...
if (isset($_GET['prescribe'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO prestb(doctor, AppID, appdate, apptime, disease, allergy, prescription) VALUES ('$doctor', '$AppID', '$appdate', '$apptime', '$disease', '$allergy', '$prescription');");
    if ($query) {
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="#list-appapp" id="list-pat-list" role="tab" data-toggle="list" aria-controls="home">
                    <i class='bx bx-list-ul'></i>
                    <span class="links_name">Approved <br> Appointments</span>
                </a>
            </li>
            <li>
    ...
    <div class="section-container" id="sections">
            ...
            <div class="overview-boxes">
                <div class="box">
                    <div class="right-side">
                        ...
                        <p class="cl-effect-1">
                            <a href="#app-list" onclick="clickDiv('#list-pat-list')">View Appointments</a>
                            &nbsp|<a href="#list-doc" onclick="clickDiv('#list-doc-list')">Approved Appointments</a>
                        </p>
                    </div>
                </div>
                <div class="box">
        ...
        <div class="home-content" id="list-app">
            <table class="app-table">
                ...
                <tbody>
                    ...
                    $query = "SELECT pid, AppID, fname, lname, gender, email, contact, appdate, apptime, userStatus, doctorStatus FROM appointmenttb WHERE doctor = '$dname';";
                    $result = mysqli_query($con, $query);
                    while ($row = mysqli_fetch_array($result)) {
                        $id = $row['AppID'];
                        $approved = isApproved($id);
        ...
        <!-- <div class="home-content" id="list-appapp">
            <table class="app-table">
                <thead>
                    <tr>
                        <th scope="col">Patient ID</th>
        ...
        <div class="home-content" id="list-pres">
            <table class="pres-table">
                ...
                <tbody>
                    ...
                    $query = "SELECT pid, fname, lname, AppID, appdate, apptime, disease, allergy, prescription FROM prestb WHERE doctor = '$doctor';";
