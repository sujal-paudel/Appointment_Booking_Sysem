...
if (isset($_GET['accept'])) {
    $AppID = $_GET['AppID'];
    $sql = mysqli_query($con, "UPDATE appointmenttb SET doctorStatus= 0 WHERE AppID = '$AppID'");
    if ($sql) {
...
// if (isset($_GET['accept'])) {
//     $AppID = $_GET['AppID'];
//     $query = mysqli_query($con, "UPDATE appointmenttb SET userStatus= 1 WHERE AppID = '$AppID'");
//     if ($query) {
//         echo "<script>alert('Your appointment was successfully Accepted.');</script>";
//     }
// }
